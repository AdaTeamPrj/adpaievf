  ...
  return (
    <div>
      <h2 id="contrat-heading" data-cy="ContratHeading">
        <Translate contentKey="adpaievfApp.contrat.home.title">Contrats</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="adpaievfApp.contrat.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/contrat/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="adpaievfApp.contrat.home.createLabel">Create new Contrat</Translate>
          </Link>
        </div>
      </h2>
        ...
        {contratList && contratList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="adpaievfApp.contrat.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.contrat.salaireBase">Salaire Base</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.contrat.emploi">Emploi</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.contrat.dateArrive">Date Arrive</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.contrat.classification">Classification</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.contrat.typeForfait">Type Forfait</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.contrat.nbHeure">Nb Heure</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.contrat.conventionCollective">Convention Collective</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.contrat.employeur">Employeur</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.contrat.employee">Employee</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {contratList.map((contrat, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`adpaievfApp.TypeForfait.${contrat.typeForfait}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="adpaievfApp.contrat.home.notFound">No Contrats found</Translate>
            </div>
          )
        )}
      </div>

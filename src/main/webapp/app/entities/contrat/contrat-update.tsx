  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adpaievfApp.contrat.home.createOrEditLabel" data-cy="ContratCreateUpdateHeading">
            <Translate contentKey="adpaievfApp.contrat.home.createOrEditLabel">Create or edit a Contrat</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('adpaievfApp.contrat.salaireBase')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.contrat.emploi')}
                id="contrat-emploi"
                name="emploi"
                data-cy="emploi"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.contrat.dateArrive')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.contrat.classification')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.contrat.typeForfait')}
              ...
              >
                {typeForfaitValues.map(typeForfait => (
                  <option value={typeForfait} key={typeForfait}>
                    {translate('adpaievfApp.TypeForfait.' + typeForfait)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('adpaievfApp.contrat.nbHeure')}
                id="contrat-nbHeure"
                name="nbHeure"
                data-cy="nbHeure"
                type="text"
              ...
              <ValidatedField
                ...
                label={translate('adpaievfApp.contrat.conventionCollective')}
                type="select"
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="employeur"
                data-cy="employeur"
                label={translate('adpaievfApp.contrat.employeur')}
                type="select"
              >
                <option value="" key="0" />
                {employeurs
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('adpaievfApp.contrat.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees

  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adpaievfApp.conventionCollective.home.createOrEditLabel" data-cy="ConventionCollectiveCreateUpdateHeading">
            <Translate contentKey="adpaievfApp.conventionCollective.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('adpaievfApp.conventionCollective.idcc')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.conventionCollective.nom')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.conventionCollective.position')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.conventionCollective.coefficient')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.conventionCollective.valeurPoint')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.conventionCollective.baseFixe')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.conventionCollective.salaireMinimal')}

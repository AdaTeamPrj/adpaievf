  ...
  return (
    <div>
      <h2 id="convention-collective-heading" data-cy="ConventionCollectiveHeading">
        <Translate contentKey="adpaievfApp.conventionCollective.home.title">Convention Collectives</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="adpaievfApp.conventionCollective.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="adpaievfApp.conventionCollective.home.createLabel">Create new Convention Collective</Translate>
          </Link>
        </div>
      </h2>
        ...
        {conventionCollectiveList && conventionCollectiveList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="adpaievfApp.conventionCollective.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="adpaievfApp.conventionCollective.home.notFound">No Convention Collectives found</Translate>
            </div>
          )
        )}
      </div>

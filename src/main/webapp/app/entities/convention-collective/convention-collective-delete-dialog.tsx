...
export const ConventionCollectiveDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="adpaievfApp.conventionCollective.delete.question">
        <Translate contentKey="adpaievfApp.conventionCollective.delete.question" interpolate={{ id: conventionCollectiveEntity.id }}>

  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adpaievfApp.cotisation.home.createOrEditLabel" data-cy="CotisationCreateUpdateHeading">
            <Translate contentKey="adpaievfApp.cotisation.home.createOrEditLabel">Create or edit a Cotisation</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('adpaievfApp.cotisation.name')}
                id="cotisation-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.cotisation.famille')}
              ...
              >
                {categorieValues.map(categorie => (
                  <option value={categorie} key={categorie}>
                    {translate('adpaievfApp.Categorie.' + categorie)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('adpaievfApp.cotisation.taux')}
                id="cotisation-taux"
                name="taux"
                data-cy="taux"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.cotisation.startDate')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.cotisation.endDate')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.cotisation.actuel')}

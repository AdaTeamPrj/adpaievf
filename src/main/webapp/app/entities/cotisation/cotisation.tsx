  ...
  return (
    <div>
      <h2 id="cotisation-heading" data-cy="CotisationHeading">
        <Translate contentKey="adpaievfApp.cotisation.home.title">Cotisations</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="adpaievfApp.cotisation.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/cotisation/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="adpaievfApp.cotisation.home.createLabel">Create new Cotisation</Translate>
          </Link>
        </div>
      </h2>
        ...
        {cotisationList && cotisationList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="adpaievfApp.cotisation.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.cotisation.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.cotisation.famille">Famille</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.cotisation.taux">Taux</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.cotisation.startDate">Start Date</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.cotisation.endDate">End Date</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.cotisation.actuel">Actuel</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {cotisationList.map((cotisation, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`adpaievfApp.Categorie.${cotisation.famille}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="adpaievfApp.cotisation.home.notFound">No Cotisations found</Translate>
            </div>
          )
        )}
      </div>

  ...
  return (
    <div>
      <h2 id="bonus-heading" data-cy="BonusHeading">
        <Translate contentKey="adpaievfApp.bonus.home.title">Bonuses</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="adpaievfApp.bonus.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/bonus/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="adpaievfApp.bonus.home.createLabel">Create new Bonus</Translate>
          </Link>
        </div>
      </h2>
        ...
        {bonusList && bonusList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="adpaievfApp.bonus.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.bonus.nom">Nom</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.bonus.montant">Montant</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.bonus.contrat">Contrat</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="adpaievfApp.bonus.home.notFound">No Bonuses found</Translate>
            </div>
          )
        )}
      </div>

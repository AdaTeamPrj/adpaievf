  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adpaievfApp.bonus.home.createOrEditLabel" data-cy="BonusCreateUpdateHeading">
            <Translate contentKey="adpaievfApp.bonus.home.createOrEditLabel">Create or edit a Bonus</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('adpaievfApp.bonus.nom')}
                id="bonus-nom"
                name="nom"
                data-cy="nom"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.bonus.montant')}
                id="bonus-montant"
                name="montant"
                data-cy="montant"
                type="text"
              ...
              <ValidatedField
                ...
                name="contrat"
                data-cy="contrat"
                label={translate('adpaievfApp.bonus.contrat')}
                type="select"
              >
                <option value="" key="0" />
                {contrats

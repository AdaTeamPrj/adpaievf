  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adpaievfApp.tauxDImposition.home.createOrEditLabel" data-cy="TauxDImpositionCreateUpdateHeading">
            <Translate contentKey="adpaievfApp.tauxDImposition.home.createOrEditLabel">Create or edit a TauxDImposition</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('adpaievfApp.tauxDImposition.taux')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.tauxDImposition.minSalary')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.tauxDImposition.maxSalary')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.tauxDImposition.startDate')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.tauxDImposition.endDate')}

  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adpaievfApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
            <Translate contentKey="adpaievfApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('adpaievfApp.location.numeroRue')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.location.nomVoie')}
                id="location-nomVoie"
                name="nomVoie"
                data-cy="nomVoie"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.location.streetName')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.location.postalCode')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.location.city')}
                id="location-city"
                name="city"
                data-cy="city"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.location.nomDepartement')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.location.nomRegion')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.location.employee')}
              ...
              <ValidatedField
                label={translate('adpaievfApp.location.employeur')}

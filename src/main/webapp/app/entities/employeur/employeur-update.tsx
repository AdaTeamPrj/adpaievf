  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adpaievfApp.employeur.home.createOrEditLabel" data-cy="EmployeurCreateUpdateHeading">
            <Translate contentKey="adpaievfApp.employeur.home.createOrEditLabel">Create or edit a Employeur</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('adpaievfApp.employeur.name')}
                id="employeur-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.employeur.numeroSiret')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.employeur.numApe')}
                id="employeur-numApe"
                name="numApe"
                data-cy="numApe"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.employeur.numUrssaf')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.employeur.conventionCollective')}

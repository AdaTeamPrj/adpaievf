  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adpaievfApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="adpaievfApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('adpaievfApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('adpaievfApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.employee.numeroSecuriteSociale')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.employee.qualification')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.employee.tauxImposition')}
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('adpaievfApp.employee.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                label={translate('adpaievfApp.employee.job')}
                id="employee-job"
                data-cy="job"
                type="select"
                multiple

  ...
  return (
    <div>
      <h2 id="heure-sup-heading" data-cy="HeureSupHeading">
        <Translate contentKey="adpaievfApp.heureSup.home.title">Heure Sups</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="adpaievfApp.heureSup.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/heure-sup/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="adpaievfApp.heureSup.home.createLabel">Create new Heure Sup</Translate>
          </Link>
        </div>
      </h2>
        ...
        {heureSupList && heureSupList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="adpaievfApp.heureSup.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.heureSup.date">Date</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.heureSup.nbHeure">Nb Heure</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.heureSup.employee">Employee</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="adpaievfApp.heureSup.home.notFound">No Heure Sups found</Translate>
            </div>
          )
        )}
      </div>

  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adpaievfApp.heureSup.home.createOrEditLabel" data-cy="HeureSupCreateUpdateHeading">
            <Translate contentKey="adpaievfApp.heureSup.home.createOrEditLabel">Create or edit a HeureSup</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('adpaievfApp.heureSup.date')} id="heure-sup-date" name="date" data-cy="date" type="date" />
              <ValidatedField
                label={translate('adpaievfApp.heureSup.nbHeure')}
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('adpaievfApp.heureSup.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees

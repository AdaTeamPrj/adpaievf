  ...
  return (
    <div>
      <h2 id="conge-heading" data-cy="CongeHeading">
        <Translate contentKey="adpaievfApp.conge.home.title">Conges</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="adpaievfApp.conge.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/conge/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="adpaievfApp.conge.home.createLabel">Create new Conge</Translate>
          </Link>
        </div>
      </h2>
        ...
        {congeList && congeList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="adpaievfApp.conge.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.conge.holdateStart">Holdate Start</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.conge.holdateEnd">Holdate End</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.conge.nbCongeAcquis">Nb Conge Acquis</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.conge.nbCongePris">Nb Conge Pris</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.conge.dateDemande">Date Demande</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.conge.decision">Decision</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.conge.dateReponse">Date Reponse</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.conge.contrat">Contrat</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {congeList.map((conge, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`adpaievfApp.Decision.${conge.decision}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="adpaievfApp.conge.home.notFound">No Conges found</Translate>
            </div>
          )
        )}
      </div>

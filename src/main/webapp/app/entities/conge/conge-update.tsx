  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adpaievfApp.conge.home.createOrEditLabel" data-cy="CongeCreateUpdateHeading">
            <Translate contentKey="adpaievfApp.conge.home.createOrEditLabel">Create or edit a Conge</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('adpaievfApp.conge.holdateStart')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.conge.holdateEnd')}
                id="conge-holdateEnd"
                name="holdateEnd"
                data-cy="holdateEnd"
                type="date"
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.conge.nbCongeAcquis')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.conge.nbCongePris')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.conge.dateDemande')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.conge.decision')}
                id="conge-decision"
                name="decision"
                data-cy="decision"
                type="select"
              >
                {decisionValues.map(decision => (
                  <option value={decision} key={decision}>
                    {translate('adpaievfApp.Decision.' + decision)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('adpaievfApp.conge.dateReponse')}
              ...
              <ValidatedField
                ...
                name="contrat"
                data-cy="contrat"
                label={translate('adpaievfApp.conge.contrat')}
                type="select"
              >
                <option value="" key="0" />
                {contrats

  ...
  return (
    <div>
      <h2 id="fiche-de-paie-heading" data-cy="FicheDePaieHeading">
        <Translate contentKey="adpaievfApp.ficheDePaie.home.title">Fiche De Paies</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="adpaievfApp.ficheDePaie.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/fiche-de-paie/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="adpaievfApp.ficheDePaie.home.createLabel">Create new Fiche De Paie</Translate>
          </Link>
        </div>
      </h2>
        ...
        {ficheDePaieList && ficheDePaieList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="adpaievfApp.ficheDePaie.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.ficheDePaie.salaireBrut">Salaire Brut</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.ficheDePaie.startDate">Start Date</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.ficheDePaie.endDate">End Date</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.ficheDePaie.datePaiement">Date Paiement</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.ficheDePaie.salaireNet">Salaire Net</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.ficheDePaie.montantNetAvantImpots">Montant Net Avant Impots</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.ficheDePaie.proFees">Pro Fees</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.ficheDePaie.deductions">Deductions</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.ficheDePaie.contrat">Contrat</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.ficheDePaie.employeur">Employeur</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.ficheDePaie.imposition">Imposition</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.ficheDePaie.cotisation">Cotisation</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.ficheDePaie.mentionsObligatoires">Mentions Obligatoires</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="adpaievfApp.ficheDePaie.home.notFound">No Fiche De Paies found</Translate>
            </div>
          )
        )}
      </div>

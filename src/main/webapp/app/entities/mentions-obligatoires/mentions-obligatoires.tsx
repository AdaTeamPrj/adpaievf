  ...
  return (
    <div>
      <h2 id="mentions-obligatoires-heading" data-cy="MentionsObligatoiresHeading">
        <Translate contentKey="adpaievfApp.mentionsObligatoires.home.title">Mentions Obligatoires</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="adpaievfApp.mentionsObligatoires.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="adpaievfApp.mentionsObligatoires.home.createLabel">Create new Mentions Obligatoires</Translate>
          </Link>
        </div>
      </h2>
        ...
        {mentionsObligatoiresList && mentionsObligatoiresList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="adpaievfApp.mentionsObligatoires.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.mentionsObligatoires.mention">Mention</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfApp.mentionsObligatoires.description">Description</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="adpaievfApp.mentionsObligatoires.home.notFound">No Mentions Obligatoires found</Translate>
            </div>
          )
        )}
      </div>

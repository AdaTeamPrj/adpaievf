...
export const MentionsObligatoiresDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="adpaievfApp.mentionsObligatoires.delete.question">
        <Translate contentKey="adpaievfApp.mentionsObligatoires.delete.question" interpolate={{ id: mentionsObligatoiresEntity.id }}>

  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adpaievfApp.mentionsObligatoires.home.createOrEditLabel" data-cy="MentionsObligatoiresCreateUpdateHeading">
            <Translate contentKey="adpaievfApp.mentionsObligatoires.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('adpaievfApp.mentionsObligatoires.mention')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfApp.mentionsObligatoires.description')}
